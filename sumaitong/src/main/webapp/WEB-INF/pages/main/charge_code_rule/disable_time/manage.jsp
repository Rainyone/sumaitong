...
<div class='span7 box bordered-box blue-border' style='margin-bottom:0;'>
  <div class='box-header' id='disable-time-header'>
    <div class='title'>失效时间设置</div>
    <div class='actions'></div>
  </div>
  <div class='box-content box-no-padding'>
    <div class='responsive-table'>
      <div class='scrollable-area-x'>
      		<table id="chargeCodeTimeRuleTable"></table>
      </div>
    </div>
  </div>
</div>
...
<script>
  seajs.use(['base','main/charge_code_rule/disable_time/manage'],function(b,m){
	b.init();
    m.init('${ctx}');
  });
</script>
